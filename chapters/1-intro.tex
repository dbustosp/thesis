...
La solución propuesta solo considera la planificación y procesamiento de transacciones de lectura, debido a que las transacciones de escritura requieren un tratamiento diferente.
