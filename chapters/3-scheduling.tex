...
Lograr bajos tiempos de respuestas es un objetivo principal en el diseño de un motor de búsqueda. 
...
Para proveer una respuesta oportuna al usuario, los motores de búsqueda poseen acuerdos de nivel de servicio, por ejemplo, que el 99% de las consultas sean respondidas en 100 ms. 
