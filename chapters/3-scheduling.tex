...
En \citep{Macdonald:2012} se propone un método de predicción de tiempo de respuesta de una transacción de lectura basado en datos estadísticos disponibles en las respectivas listas invertidas de los términos. Cuando una consulta llega al sistema, para cada uno de los términos de esta \textit{query} y desde su propia lista invertida se calcula los siguientes estadísticos $s(t)$:
