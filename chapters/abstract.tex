...
The results show that query efficiency predictors can lead to reduced processing time of large query batches and that some query predictors may become data dependents. This work also shows that, in the context of search engine, state of the art algorithms for query scheduling are very dependents of predictor accuracy, whereby this work presents a query processing technique based on work units that yields significant improvements in total processing times.
